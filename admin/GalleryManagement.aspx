<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GalleryManagement.aspx.cs" Inherits="admin_GalleryManagement" %>
...
<head runat="server">
    ...
    <title>Gallery Management - KUET Cyborg</title>
        ...
        <div class="dashboard-container">
            ...
            <aside class="sidebar">
                ...
                <nav>
                    ...
                    <a href="GalleryManagement.aspx" class="nav-item active">
            ...
            <main class="main-content">
                <div class="page-header">
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="+ Add Image" CssClass="btn btn-primary" style="width: auto;" OnClick="btnAdd_Click" />
                </div>
                ...
                <div class="grid-container glass">
                    <asp:GridView ID="gvGallery" runat="server" AutoGenerateColumns="false" 
                        ...
                        OnRowCommand="gvGallery_RowCommand" DataKeyNames="id">
                        <Columns>
                            <asp:TemplateField HeaderText="Image">
                                <ItemTemplate>
                                    <img src='<%# "../" + Eval("image_url") %>' alt="" style="width: 80px; height: 45px; object-fit: cover; border-radius: 4px;" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="title" HeaderText="Title" />
                            <asp:BoundField DataField="image_url" HeaderText="Image Path" />
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" 
                                        CommandName="EditGallery" CommandArgument='<%# Eval("id") %>' 
                                        CssClass="action-btn btn-success" ToolTip="Edit Image">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" /></svg>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server" 
                                        CommandName="DeleteGallery" CommandArgument='<%# Eval("id") %>' 
                                        CssClass="action-btn btn-danger" ToolTip="Delete Image"
                ...
                <asp:Panel ID="pnlModal" runat="server" CssClass="modal-bg" Visible="false">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3><asp:Literal ID="litModalTitle" runat="server" Text="Add Image"></asp:Literal></h3>
                        ...
                        <div class="form-group">
                            <label>Image URL Path (e.g. assets/galary/club_mettup.jpg)</label>
                            <asp:TextBox ID="txtImageUrl" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                        </div>
                        <asp:Button ID="btnSave" runat="server" Text="Save Image" CssClass="btn btn-primary" OnClick="btnSave_Click" />
                    </div>
                </asp:Panel>
