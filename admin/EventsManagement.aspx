...
<head runat="server">
    ...
    <title>Events Management - KUET Cyborg</title>
        ...
        <div class="dashboard-container">
            ...
            <aside class="sidebar">
                ...
                <nav>
                    ...
                    <a href="EventsManagement.aspx" class="nav-item active">
            ...
            <main class="main-content">
                <div class="page-header">
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="+ Add Event" CssClass="btn btn-primary" style="width: auto;" OnClick="btnAdd_Click" />
                </div>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" 
                                        ...
                                        CssClass="action-btn btn-success" ToolTip="Edit Event">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" /></svg>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server" 
                                        CommandName="DeleteEvent" CommandArgument='<%# Eval("id") %>' 
                                        CssClass="action-btn btn-danger" ToolTip="Delete Event"
                ...
                <asp:Panel ID="pnlModal" runat="server" CssClass="modal-bg" Visible="false">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3><asp:Literal ID="litModalTitle" runat="server" Text="Add Event"></asp:Literal></h3>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Event Date (e.g. June 2026)</label>
                                <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label>Status (upcoming / past)</label>
                            ...
                            <div class="form-group">
                                <label>Alignment (left / right)</label>
                                <asp:DropDownList ID="ddlAlignment" runat="server" CssClass="form-control">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Save Event" CssClass="btn btn-primary" OnClick="btnSave_Click" />
                    </div>
                </asp:Panel>
